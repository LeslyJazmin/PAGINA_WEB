...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestindicadoresSST
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_indicadoresSST'] = $row['nota_videotestindicadoresSST'];
} else {
    $_SESSION['nota_videotest_indicadoresSST'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 23; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_indicadoresSST'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/indicadoresSST.jpg" alt="Imagen de Indicadores de Gestión de SST">
                    <div class="overlay">
                        <h2>Curso de Indicadores de Gestión de SST</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Indicadores de Gestión de SST</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Indicadores de Gestión de SST</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_indicadoresSST'] == 16 || $_SESSION['nota_videotest_indicadoresSST'] == 20): ?>
...
$id_curso = 23;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span> Indicadores de Gestión de SST </span>
        <input type="hidden" id="id_curso" name="id_curso" value="23">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen de Indicadores de Gestión de SST</h2>
                <img src="images/indicadoresGestion.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_indicadoresSST'][23]) ? $_SESSION['nota_mas_alta_por_curso_indicadoresSST'][23] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenindicadoresSST.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_indicadoresSST']) ? $_SESSION['nota_mas_alta_indicadoresSST'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Indicadores de Gestión de SST </h2>
                <img src="images/SST.jpg" alt="Imagen de Indicadores de Gestión de SST">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestindicadoresSST.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestindicadoresSST.php"; // Cambia este enlace al videotest
            };
