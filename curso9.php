...
<head>
    ...
    <title> CURSO DE AUTOCAD 2D Y 3D </title>
...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1>CURSO DE AUTOCAD 2D Y 3D</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/AutoCAD 2D y 3D 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/AutoCAD 2D y 3D 2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images/AutoCAD 2D y 3D 3.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
    ...
    <header class="header-secondary">
        <div class="container">
            <h2><strong> 🌐 ¡Únete Ahora! </strong>"Diseña el futuro con precisión y creatividad." <br>¡Inscríbete ahora y lleva tus ideas del plano a la realidad!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE AUTOCAD 2D Y 3D. Todos los derechos reservados.</strong>
        </div>
    </footer>
