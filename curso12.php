...
<head>
    ...
    <title> CURSO DE HOMOLOGACIÓN 3G EN PROCESO SMAW </title>
...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1>CURSO DE HOMOLOGACIÓN 3G EN PROCESO SMAW</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/Homologación de Soldadores 3G 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/Homologación de Soldadores 3G 2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images/Homologación de Soldadores 3G 3.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
    ...
    <header class="header-secondary">
        <div class="container">
            <h2><strong> 🌐 ¡Únete Ahora! </strong>"Tu técnica define tu nivel, tu seguridad lo eleva."<br>¡Inscríbete ahora y certifícate con confianza en 3G SMAW!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE HOMOLOGACIÓN 3G EN PROCESO SMAW. Todos los derechos reservados.</strong>
        </div>
    </footer>
