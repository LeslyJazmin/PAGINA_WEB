...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_Homologacion6G'] = $row['nota_videotestHomologacion4G'];
} else {
    $_SESSION['nota_videotest_Homologacion6G'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 30; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_Homologacion6G'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/Homologacion6G.jpg" alt="Imagen de Homologacion 4G">
                    <div class="overlay">
                        <h2>Curso de Homologación 6G en proceso smaw</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Homologación 6G en proceso smaw</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Homologación 6G en proceso smaw</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_Homologacion6G'] == 16 || $_SESSION['nota_videotest_Homologacion6G'] == 20): ?>
...
$id_curso = 30;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span> Homologación 6G en proceso smaw </span>
        <input type="hidden" id="id_curso" name="id_curso" value="30">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2> Examen de Homologación 6G en proceso smaw </h2>
                <img src="images/homolo6G.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_Homologacion6G'][30]) ? $_SESSION['nota_mas_alta_por_curso_Homologacion6G'][30] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenHomologacion6G.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_Homologacion6G']) ? $_SESSION['nota_mas_alta_Homologacion6G'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Homologación 6G en proceso smaw </h2>
                <img src="images/6Gh.jpg" alt="Imagen de Homologación 6G en proceso smaw">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestHomologacion6G.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestHomologacion6G.php"; // Cambia este enlace al videotest
            };
