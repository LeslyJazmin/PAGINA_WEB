...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestme
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_me'] = $row['nota_videotestme'];
} else {
    $_SESSION['nota_videotest_me'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 3; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_me'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/cur4.jpeg" alt="Imagen de Curso de Uso y manejo de extintores">
                    <div class="overlay">
                        <h2>Curso de Uso y manejo de extintores</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Uso y manejo de extintores</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Uso y manejo de extintores</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_me'] == 16 || $_SESSION['nota_videotest_me'] == 20): ?>
...
$id_curso = 3;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <input type="hidden" id="id_curso" name="id_curso" value="3">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen Final de Uso y manejo de extintores</h2>
                <img src="images/examenme.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_me'][3]) ? $_SESSION['nota_mas_alta_por_curso_me'][3] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenme.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_me']) ? $_SESSION['nota_mas_alta_me'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Uso y manejo de extintores </h2>
                <img src="images/usome.jpg" alt="Imagen de Uso y manejo de extintores">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestme.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestme.php"; // Cambia este enlace al videotest
            };
