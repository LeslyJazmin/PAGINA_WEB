...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestseguridadTC
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_seguridadTC'] = $row['nota_videotestseguridadTC'];
} else {
    $_SESSION['nota_videotest_seguridadTC'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 26; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_seguridadTC'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/segurityTC.jpg" alt="Imagen de Seguridad en trabajos confinados">
                    <div class="overlay">
                        <h2>Curso de Seguridad en trabajos confinados</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Seguridad en trabajos confinados</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Seguridad en trabajos confinados</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_seguridadTC'] == 16 || $_SESSION['nota_videotest_seguridadTC'] == 20): ?>
...
$id_curso = 26;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span> Seguridad en trabajos confinados</span>
        <input type="hidden" id="id_curso" name="id_curso" value="26">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen Seguridad en trabajos confinados</h2>
                <img src="images/seguriConfi.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_seguridadTC'][26]) ? $_SESSION['nota_mas_alta_por_curso_seguridadTC'][26] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenseguridadTC.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_seguridadTC']) ? $_SESSION['nota_mas_alta_seguridadTC'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Seguridad en trabajos confinados </h2>
                <img src="images/TrabajoConfina.jpg" alt="Imagen de Seguridad en trabajos confinados">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestseguridadTC.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestseguridadTC.php"; // Cambia este enlace al videotest
            };
