...
<head>
    ...
    <title> CURSO DE OFIMÁTICA </title>
...
<body>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/Ofimática 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/Ofimática 2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images/Ofimática 3.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
    ...
    <header class="header-secondary">
        <div class="container">
            <h2><strong> 🌐 ¡Únete Ahora! </strong> "Domina las herramientas que impulsan tu productividad." <br>¡Inscríbete ahora y potencia tus habilidades digitales!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE OFIMÁTICA. Todos los derechos reservados.</strong>
        </div>
    </footer>
