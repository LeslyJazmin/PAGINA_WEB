...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestHomologacion4G
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_Homologacion4G'] = $row['nota_videotestHomologacion4G'];
} else {
    $_SESSION['nota_videotest_Homologacion4G'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 29; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_Homologacion4G'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/Homologacion4G.jpg" alt="Imagen de Homologacion 4G">
                    <div class="overlay">
                        <h2>Curso de Homologación 4G en proceso smaw</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Homologación 4G en proceso smaw</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Homologación 4G en proceso smaw</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_Homologacion4G'] == 16 || $_SESSION['nota_videotest_Homologacion4G'] == 20): ?>
...
$id_curso = 29;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span> Homologación 4G en proceso smaw </span>
        <input type="hidden" id="id_curso" name="id_curso" value="29">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2> Examen de Homologación 4G en proceso smaw </h2>
                <img src="images/4Gh.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_Homologacion4G'][29]) ? $_SESSION['nota_mas_alta_por_curso_Homologacion4G'][29] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenHomologacion4G.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_Homologacion4G']) ? $_SESSION['nota_mas_alta_Homologacion4G'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Homologación 4G en proceso smaw </h2>
                <img src="images/homolo4G.jpg" alt="Imagen de Homologación 4G en proceso smaw">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestHomologacion4G.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestHomologacion4G.php"; // Cambia este enlace al videotest
            };
