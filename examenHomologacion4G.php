...
function inicializarSesion() {
    ...
    $_SESSION['id_curso'] = 29; // Curso de primeros auxilios
}
...
<body>
    ...
    <?php else: ?>
        ...
        <?php if ($_SESSION['intentos_por_curso_Homologacion4G'][29] < 3): ?>
            ...
            <div class="mensaje">
                El puntaje más alto obtenido hasta ahora es <?php echo max($_SESSION['notas_por_curso_Homologacion4G']); ?> puntos.
            </div>
