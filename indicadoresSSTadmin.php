            ...
            <ul>
                ...
                <li>
                    ...
                    <ul class="subcursos">
                        ...
                        <li><a href="sadmi.php" style="color: #000;">Soldadura</a></li>
                        ...
                        <li><a href="seguridadSDadmin.php" style="color: #000;">Seguridad para Trabajos con Soldadura</a></li>
                        <li><a href="seguridaTEadmin.php" style="color: #000;">Seguridad para Trabajos en Excavaciones</a></li>
        ...
        <div class="main-content">
            <div class="contenido-principal">
                ...
                <form action="guardar_datos.php" method="POST">
                    ...
                    <input type="hidden" name="id_curso" value="23">
