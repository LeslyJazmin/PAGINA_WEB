...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestseguridad
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_seguridad'] = $row['nota_videotestseguridad'];
} else {
    $_SESSION['nota_videotest_seguridad'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 19; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_seguridad'];
...
<head>
    ...
    <title> Seguridad para Trabajos con Altura</title>
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/SeguridadTA.jpg" alt="Imagen de Seguridad para Trabajos con Altura">
                    <div class="overlay">
                        <h2>Curso de Seguridad para Trabajos con Alturas</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Seguridad para Trabajos con Altura</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Seguridad para Trabajos con Altura</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_seguridad'] == 16 || $_SESSION['nota_videotest_seguridad'] == 20): ?>
...
$id_curso = 19;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span>Seguridad para Trabajos con Altura</span>
        <input type="hidden" id="id_curso" name="id_curso" value="19">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen Seguridad para Trabajos con Altura</h2>
                <img src="images/TrabajoAltura.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_seguridad'][19]) ? $_SESSION['nota_mas_alta_por_curso_seguridad'][19] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenseguridad.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_seguridad']) ? $_SESSION['nota_mas_alta_seguridad'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Seguridad para Trabajos con Altura </h2>
                <img src="images/segurty.png" alt="Imagen de Uso y manejo de extintores">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestseguridad.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestseguridad.php"; // Cambia este enlace al videotest
            };
