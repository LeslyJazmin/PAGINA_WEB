...
<body>
    ...
    <header class="header-secondary">
        <div class="container">
            <h2> 🌐 ¡Únete Ahora! "La formación constante es la clave del éxito<br>para todo profesional comprometido."
                ¡Inscríbete ahora y <br>comienza a marcar la diferencia!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO IPERC. Todos los derechos reservados.</strong>
        </div>
    </footer>
