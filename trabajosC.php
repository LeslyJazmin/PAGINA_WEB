...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotesttrabajosC
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_trabajosC'] = $row['nota_videotesttrabajosC'];
} else {
    $_SESSION['nota_videotest_trabajosC'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 25; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_trabajosC'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/trabajosC.jpg" alt="Imagen de Seguridad para Trabajos en Caliente">
                    <div class="overlay">
                        <h2>Curso de Seguridad para Trabajos en Caliente</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Seguridad para Trabajos en Caliente</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Seguridad para Trabajos en Caliente</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_trabajosC'] == 16 || $_SESSION['nota_videotest_trabajosC'] == 20): ?>
...
$id_curso = 25;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span>Seguridad para Trabajos en Caliente</span>
        <input type="hidden" id="id_curso" name="id_curso" value="25">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen de Seguridad para Trabajos en Caliente</h2>
                <img src="images/seguridadtc.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_trabajosC'][25]) ? $_SESSION['nota_mas_alta_por_curso_trabajosC'][25] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examentrabajosC.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_trabajosC']) ? $_SESSION['nota_mas_alta_trabajosC'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Seguridad para Trabajos en Caliente </h2>
                <img src="images/tCaliente.jpeg" alt="Imagen de Seguridad para Trabajos en Caliente">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotesttrabajosC.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotesttrabajosC.php"; // Cambia este enlace al videotest
            };
