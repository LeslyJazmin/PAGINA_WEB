...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestpa
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_pa'] = $row['nota_videotestpa'];
} else {
    $_SESSION['nota_videotest_pa'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 2; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_pa'];
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/cur2.jpeg" alt="Imagen de curso de primeros auxilios">
                    <div class="overlay">
                        <h2>Curso de Primeros Auxilios</h2>
                    </div>
                </div>
        ...
        <tr class="table-link">
            <td>
                ...
                <?php if ($link_material): ?>
                    <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material del Curso</a>
                <?php else: ?>
        ...
        <tr class="table-link">
            <td>
                ...
                <?php if ($link_video): ?>
                    <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video del Curso</a>
                <?php else: ?>
                ...
                <?php endif; ?>
                        ...
                        <tbody>
                            ...
                            <tr class="table-link">
                                ...
                                <i class="fas fa-book"></i> 
                                    <?php if ($_SESSION['nota_videotest_pa'] == 16 || $_SESSION['nota_videotest_pa'] == 20): ?>
                        ...
                        include 'conexion.php';  // Asegúrate de que la conexión a la base de datos esté disponible
                                ...
                                $id_curso = 2;  // El ID del curso actual (puedes cambiarlo según el curso específico)
                                ...
                                ?>
                                    <form action="buscar_curso.php" method="post" class="form-certificado">
                                        ...
                                        <input type="hidden" id="id_curso" name="id_curso" value="2">
                                        <br>
    ...
    <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen Final de Primeros Auxilios</h2>
                <img src="images/examenpa.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso'][2]) ? $_SESSION['nota_mas_alta_por_curso'][2] : 0; ?></span></span>
                </div>

                <form method="POST" action="examenpa.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_pa']) ? $_SESSION['nota_mas_alta_pa'] : 0; ?>;
...
<div id="videotestModal" class="modal">
    <div class="modal-content">
        ...
        <h2> Videotest de Primeros Auxilios </h2>
        <img src="images/doctor-providing-first-aid.jpg" alt="Imagen de Primeros Auxilios">
        <h3>Información</h3>
        <div class="exam-details">
            <div class="detail-container">
                <i class="fas fa-calendar-alt"></i>
...
<script>
// Obtener las fechas y horas de inicio y entrega
...
function verificarDisponibilidad() {
    ...
    if (fechaActual >= fechaInicio && fechaActual <= fechaEntrega) {
        ...
        mensajeElement.innerHTML = ";  // Limpiar mensaje de disponibilidad
...
function redirigirAVideoTest() {
    window.location.href = 'videotestpa.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestpa.php"; // Cambia este enlace al videotest
            };
