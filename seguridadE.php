...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestseguridadE
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_seguridadE'] = $row['nota_videotestseguridadE'];
} else {
    $_SESSION['nota_videotest_seguridadE'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 20; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_seguridadE'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/SElectrica.jpg" alt="Imagen de Seguridad para Trabajos Eléctricos">
                    <div class="overlay">
                        <h2>Curso de Seguridad para Trabajos Eléctricos</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Seguridad para Trabajos Eléctricos</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Seguridad para Trabajos Eléctricos</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_seguridadE'] == 16 || $_SESSION['nota_videotest_seguridadE'] == 20): ?>
...
$id_curso = 20;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span>Seguridad para Trabajos Eléctricos</span>
        <input type="hidden" id="id_curso" name="id_curso" value="20">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen Seguridad para Trabajos Eléctricos</h2>
                <img src="images/TrabajoElectrico.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_seguridadE'][20]) ? $_SESSION['nota_mas_alta_por_curso_seguridadE'][20] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenseguridadE.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_seguridadE']) ? $_SESSION['nota_mas_alta_seguridadE'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Seguridad para Trabajos Eléctricos </h2>
                <img src="images/segurity.png" alt="Imagen de Seguridad para Trabajos Eléctricos">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestseguridadE.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestseguridadE.php"; // Cambia este enlace al videotest
            };
