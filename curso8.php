...
<head>
    ...
    <title> CURSO DE INDICADORES DE GESTIÓN DE SST </title>
...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1>CURSO DE INDICADORES DE GESTIÓN DE SST</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/Indicadores de gestión de SST 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/Indicadores de gestión de SST 2.png'); /* Ruta de la imagen para la página 2 */
            }
    ...
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE INDICADORES DE GESTIÓN DE SST. Todos los derechos reservados.</strong>
        </div>
    </footer>
