...
<head>
    ...
    <title> CURSO DE SEGURIDAD PARA TRABAJOS EN CALIENTE </title>
...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1>CURSO DE SEGURIDAD PARA TRABAJOS EN CALIENTE</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/Seguridad en trabajos en caliente 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/Seguridad en trabajos en caliente 2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images/Seguridad en trabajos en caliente 3.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
    ...
    <header class="header-secondary">
        <div class="container">
            <h2><strong> 🌐 ¡Únete Ahora! </strong>"Controla el riesgo antes de encender la chispa." <br>¡Inscríbete ahora y domina la seguridad en trabajos térmicos!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE SEGURIDAD PARA TRABAJOS EN CALIENTE. Todos los derechos reservados.</strong>
        </div>
    </footer>
