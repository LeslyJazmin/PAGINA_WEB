...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestsa
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_sa'] = $row['nota_videotestsa'];
} else {
    $_SESSION['nota_videotest_sa'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 1; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_sa'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/cur3.jpeg" alt="Imagen de curso de Soldadura con arco eléctrico electrodo revestido">
                    <div class="overlay">
                        <h2>Curso de Soldadura con arco eléctrico electrodo revestido</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Soldadura con arco eléctrico electrodo revestido</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Soldadura con arco eléctrico electrodo revestido</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_sa'] == 16 || $_SESSION['nota_videotest_sa'] == 20): ?>
...
$id_curso = 1;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span>Soldadura con arco eléctrico electrodo revestido</span>
        <input type="hidden" id="id_curso" name="id_curso" value="1">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen Final de Soldadura con arco eléctrico electrodo revestido</h2>
                <img src="images/examensa.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_sa'][1]) ? $_SESSION['nota_mas_alta_por_curso_sa'][1] : 0; ?></span></span>
                </div>
                <form method="POST" action="examensoldadura.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_sa']) ? $_SESSION['nota_mas_alta_sa'] : 0; ?>;
...
<div id="videotestModal" class="modal">
    <div class="modal-content">
        ...
        <h2> Videotest de Soldadura con arco eléctrico electrodo revestido </h2>
        <img src="images/soldadura.png" alt="Imagen de Soldadura con arco eléctrico electrodo revestido">
        <h3>Información</h3>
...
var fechaInicio = new Date("<?php echo $fecha_inicio; ?> <?php echo $hora_inicio; ?>");
var fechaEntrega = new Date("<?php echo $fecha_entrega; ?> <?php echo $hora_entrega; ?>");
...
function verificarDisponibilidad() {
    ...
    if (fechaActual >= fechaInicio && fechaActual <= fechaEntrega) {
    ...
    } else if (fechaActual > fechaEntrega) {
        ...
        mensajeElement.innerHTML = "El videotest estará disponible el " + fechaInicio.toLocaleDateString() + " a las " + "<?php echo $hora_inicio; ?>";
...
function redirigirAVideoTest() {
    window.location.href = 'videotestsa.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestsa.php"; // Cambia este enlace al videotest
            };
