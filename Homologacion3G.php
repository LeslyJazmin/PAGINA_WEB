...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestHomologacion3G
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_Homologacion3G'] = $row['nota_videotestHomologacion3G'];
} else {
    $_SESSION['nota_videotest_Homologacion3G'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 28; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_Homologacion3G'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    <img src="images/Homologacion3G.jpg" alt="Imagen de Homologación 3G en proceso smaw">
                    <div class="overlay">
                        <h2>Curso de Homologación 3G en proceso smaw</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - Homologación 3G en proceso smaw</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - Homologación 3G en proceso smaw</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_Homologacion3G'] == 16 || $_SESSION['nota_videotest_Homologacion3G'] == 20): ?>
...
$id_curso = 28;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <span> Homologación 3G en proceso smaw </span>
        <input type="hidden" id="id_curso" name="id_curso" value="28">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2> Examen de Homologación 3G en proceso smaw </h2>
                <img src="images/3dhomo.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_Homologacion3G'][28]) ? $_SESSION['nota_mas_alta_por_curso_Homologacion3G'][28] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenHomologacion3G.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_Homologacion3G']) ? $_SESSION['nota_mas_alta_Homologacion3G'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de Homologación 3G en proceso smaw </h2>
                <img src="images/3dH.jpg" alt="Imagen de Homologación 3G en proceso smaw">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestHomologacion3G.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestHomologacion3G.php"; // Cambia este enlace al videotest
            };
