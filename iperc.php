...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestiperc
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_iperc'] = $row['nota_videotestiperc'];
} else {
    $_SESSION['nota_videotest_iperc'] = '--'; // Valor por defecto si no hay datos
}
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_iperc'];
...
<head>
    ...
    <title>IPERC : Identificación de Peligros y evaluación de Riesgos</title>
...
<body>
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    ...
                    <div class="overlay">
                        <h2>Curso de IPERC : Identificación de Peligros y evaluación de Riesgos </h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - IPERC</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - IPERC</a>
                            <?php else: ?>
                        ...
                        <tbody>
                            ...
                            <tr class="table-link">
                                ...
                                <i class="fas fa-book"></i> 
                                    <?php if ($_SESSION['nota_videotest_iperc'] == 16 || $_SESSION['nota_videotest_iperc'] == 20): ?>
                        ...
                        include 'conexion.php';  // Asegúrate de que la conexión a la base de datos esté disponible
                                ...
                                $id_curso = 4;  // El ID del curso actual (puedes cambiarlo según el curso específico)
                                ...
                                ?>
                                    <form action="buscar_curso.php" method="post" class="form-certificado">
                                        ...
                                        <span>IPERC : Identificación de Peligros y evaluación de Riesgos</span>
                                        <input type="hidden" id="id_curso" name="id_curso" value="4">
                                        <br>
    ...
    <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen Final de IPERC</h2>
                <img src="images/exameniperc.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_iperc'][4]) ? $_SESSION['nota_mas_alta_por_curso_iperc'][4] : 0; ?></span></span>
                </div>

                <form method="POST" action="exameniperc.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_iperc']) ? $_SESSION['nota_mas_alta_iperc'] : 0; ?>;
...
<div id="videotestModal" class="modal">
    <div class="modal-content">
        ...
        <h2> Videotest de IPERC</h2>
        <img src="images/iperc.jpg" alt="Imagen de Primeros Auxilios">
        <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestiperc.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestiperc.php"; // Cambia este enlace al videotest
            };
