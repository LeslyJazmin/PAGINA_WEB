...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1>CURSO DE SEGURIDAD PARA TRABAJOS ELÉCTRICOS</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/Seguridad para trabajos eléctricos 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/Seguridad para trabajos eléctricos 2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images/Seguridad para trabajos eléctricos  3.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
    ...
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE SEGURIDAD PARA TRABAJOS ELÉCTRICOS. Todos los derechos reservados.</strong>
        </div>
    </footer>
