...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1> CURSO DE SOLDADURA CON ARCO ELÉCTRICO CON ELECTRODO REVESTIDO</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images1/Soldadura1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images1/Soldadura2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images1/Soldadura3.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
            width: 745px; /* Ancho fijo para todos los contenedores de texto */
            height: 250px; /* Altura fija para todos los contenedores de texto */
            }   
            .footer-container {
            background-color: #0a335f;
            box-shadow: 0 4px 8px rgba(97, 157, 181, 0.884);
            }
        </style>
</header>
    ...
    <div class="container cursos-grid">
        <section class="course">
            ...
            <div class="course-text">
                <p><strong>CERTIFICACIÓN RECONOCIDA:<br></strong>MEJORA TU PERFIL PROFESIONAL CON UNA CERTIFICACIÓN AVALADA POR EXPERTOS.</p>
            </div>
        </section>  
        ...
        <section class="course">
            ...
            <div class="course-text">
                <p><strong>MATERIALES<br> </strong> <strong>EXCLUSIVOS: </strong><br>ACCEDE A GUÍAS Y RECURSOS ACTUALIZADOS SOBRE SOLDADURA</p>
            </div>
        </section>
        ...
        <section class="course">
            ...
            <div class="course-text">
                <p><strong>NETWORKING:<br></strong>CONÉCTATE CON OTROS PROFESIONALES Y AMPLÍA TU RED DE CONTACTOS EN LA INDUSTRIA.</p><br>
            </div>
        </section> 
    </div>
</header>
    ...
    <header class="header-secondary">
        <div class="container">
            <h2><strong> 🌐 ¡Únete Ahora! </strong>"Perfecciona tu técnica y abre puertas a nuevas <br> oportunidades." 
                ¡Inscríbete ahora y comienza a marcar la diferencia!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024  CURSO DE SOLDADURA CON ARCO ELÉCTRICO CON ELECTRODO REVESTIDO. Todos los derechos reservados.</strong>
        </div>
    </footer>
