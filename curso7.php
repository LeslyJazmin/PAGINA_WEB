...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1>CURSO DE SEGURIDAD PARA TRABAJOS EN ZANJAS O EXCAVACIONES</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/Seguridad para trabajos en zanjas o excavaciones 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/Seguridad para trabajos en zanjas o excavaciones 2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images/Seguridad para trabajos en zanjas o excavaciones 3.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
    ...
    <header class="header-secondary">
        <div class="container">
            <h2><strong> 🌐 ¡Únete Ahora! </strong> "Profundiza en seguridad antes que en la zanja."<br>¡Inscríbete ahora y aprende a prevenir accidentes bajo tierra!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE SEGURIDAD PARA TRABAJOS EN ZANJAS O EXCAVACIONES. Todos los derechos reservados.</strong>
        </div>
    </footer>
