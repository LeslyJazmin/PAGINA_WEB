...
$DNI = $_SESSION['DNI'];
$sql = "SELECT GREATEST(IFNULL(intento1, 0), IFNULL(intento2, 0), IFNULL(intento3, 0)) AS nota_videotestautocad
        FROM inscripciones 
...
if ($result->num_rows > 0) {
    ...
    $_SESSION['nota_videotest_autocad'] = $row['nota_videotestautocad'];
} else {
    $_SESSION['nota_videotest_autocad'] = '--'; // Valor por defecto si no hay datos
}
...
$id_curso = 24; // ID fijo del curso en este ejemplo
...
// Mostrar la nota
$nota = $_SESSION['nota_videotest_autocad'];
        ...
        <div class="main-content">
            <div class="image-info-container">
                <div class="image-container">
                    ...
                    <div class="overlay">
                        <h2>Curso de AUTOCAD 2D Y 3D</h2>
                    </div>
                </div>
                <div class="table-container">
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_material): ?>
                                <a href="#" onclick="openPdfWindow('<?php echo $link_material; ?>');">Material - AUTOCAD 2D Y 3D</a>
                            <?php else: ?>
                    ...
                    <tr class="table-link">
                        <td>
                            ...
                            <?php if ($link_video): ?>
                                <a href="#" onclick="openVideoWindow('<?php echo $link_video; ?>');">Video - AUTOCAD 2D Y 3D</a>
                            <?php else: ?>
            ...
            <?php if ($_SESSION['nota_videotest_autocad'] == 16 || $_SESSION['nota_videotest_autocad'] == 20): ?>
...
$id_curso = 24;  // El ID del curso actual (puedes cambiarlo según el curso específico)
...
?>
    <form action="buscar_curso.php" method="post" class="form-certificado">
        ...
        <input type="hidden" id="id_curso" name="id_curso" value="24">
        <br>
...
<?php endif; ?>
        ...
        <div id="examenPanel">
            ...
            <div class="panel-content">
                <h2>Examen AUTOCAD 2D Y 3D</h2>
                <img src="images/autocaP.jpg" alt="Descripción de la imagen" style="width: 100%; margin-bottom: 20px; border-radius: 5px;">
                <h3>Informacion</h3>
                ...
                <div class="detailes-container">
                 <i class="fas fa-clock"></i> 
                    ...
                    <span>Puntaje más alto: <span id="highestScorePA"><?php echo isset($_SESSION['nota_mas_alta_por_curso_autocad'][24]) ? $_SESSION['nota_mas_alta_por_curso_autocad'][24] : 0; ?></span></span>
                </div>
                    
                <form method="POST" action="examenautocad.php" id="examForm">
    ...
    color: #d8000c;
        ...
        <script>
            function actualizarPuntajeMasAltoPA() {
                var puntajeMasAlto = <?php echo isset($_SESSION['nota_mas_alta_autocad']) ? $_SESSION['nota_mas_alta_autocad'] : 0; ?>;
        ...
        <div id="videotestModal" class="modal">
            <div class="modal-content">
                ...
                <h2> Videotest de AUTOCAD 2D Y 3D </h2>
                <img src="images/autocad3D.jpg" alt="Imagen de AUTOCAD 2D Y 3D">
              <h3>Información</h3>
...
function redirigirAVideoTest() {
    window.location.href = 'videotestautocad.php';  // Redirige a videotest.php
}
        ...
        <script>
           let pdfViewed = false;
            ...
            document.getElementById('confirmBtn').onclick = function() {
                ...
                window.location.href = "videotestautocad.php"; // Cambia este enlace al videotest
            };
