...
function inicializarSesion() {
    ...
    $_SESSION['id_curso'] = 28; // Curso de primeros auxilios
}
...
<body>
    ...
    <?php else: ?>
        ...
        <?php if ($_SESSION['intentos_por_curso_Homologacion3G'][28] < 3): ?>
            ...
            <div class="mensaje">
                El puntaje más alto obtenido hasta ahora es <?php echo max($_SESSION['notas_por_curso_Homologacion3G']); ?> puntos.
            </div>
