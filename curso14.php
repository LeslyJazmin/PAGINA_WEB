...
<head>
    ...
    <title> CURSO DE HOMOLOGACIÓN 6G EN PROCESO SMAW </title>
...
<body>
    ...
    <header class="main-header">
        <div class="container">
            <h1>CURSO DE HOMOLOGACIÓN 6G EN PROCESO SMAW</h1>
        </div>
    </header>
    ...
    <style>
            ...
            #page1 {
                background-image: url('images/Homologación de Soldadores 6G 1.png'); /* Ruta de la imagen para la página 1 */
            }
    
            #page2 {
                background-image: url('images/Homologación de Soldadores 6G 2.png'); /* Ruta de la imagen para la página 2 */
            }
    
            #page3 {
                background-image: url('images/Homologación de Soldadores 6G.png'); /* Ruta de la imagen para la página 3 */
            }
            .text-container {
    ...
    <header class="header-secondary">
        <div class="container">
            <h2><strong> 🌐 ¡Únete Ahora! </strong>"6G: el estándar de los expertos." <br>¡Inscríbete ahora y alcanza la máxima calificación en soldadura!</h2>
        </div>
    </header>
    <footer>
        <div class="container">
            <strong>&copy; 2024 CURSO DE HOMOLOGACIÓN 6G EN PROCESO SMAW. Todos los derechos reservados.</strong>
        </div>
    </footer>
