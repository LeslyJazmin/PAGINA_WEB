...
<head>
    <meta charset="UTF-8">
    <title>Curso de Seguridad para Trabajos con Altura</title>
    ...
    <div class="container">
        ...
        <div class="contenido-principal">
            ...
            <div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
                ...
                <!-- Enlace para gestionar preguntas del videotest -->
                <div style="text-align: center; margin-top: 30px;">
                    <h3>Gestión de preguntas del videotest</h3>
                    <p>Haz clic en el botón para gestionar las preguntas del videotest de Seguridad para Trabajos con Altura.</p>
                    <a href="preguntasvideo.php?id_curso=19" class="update-btn" style="display: inline-block; margin: 10px; text-decoration: none; padding: 10px 20px;">Gestionar preguntas del videotest</a>
                </div>
            </div>
        </div>
    </div>
